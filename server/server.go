// Package server provides endpoints http handlers for immediate use with golang net/http package (as is the case in the example apns cli executable) or for gluing together apns package with other http server.
package server
